		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#StudentsManagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"StudentsManagement-display": {
								"semanticObject": "StudentsManagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bstu.hmss.managestudents.students",
									"url": sap.ui.require.toUrl("bstu/hmss/managestudents/students")
								}
							}
						}
					}
