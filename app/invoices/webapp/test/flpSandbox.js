		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#InvoicesManagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"InvoicesManagement-display": {
								"semanticObject": "InvoicesManagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bstu.hmss.manageinvoices.invoices",
									"url": sap.ui.require.toUrl("bstu/hmss/manageinvoices/invoices")
								}
							}
						}
					}
