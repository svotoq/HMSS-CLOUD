		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RoomsManagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RoomsManagement-display": {
								"semanticObject": "RoomsManagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bstu.hmss.managerooms.rooms",
									"url": sap.ui.require.toUrl("bstu/hmss/managerooms/rooms")
								}
							}
						}
					}
